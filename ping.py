...
class Ping(commands.Cog):
    ...
    @commands.command(brief="Get bot status")
    async def ping(self, ctx):
        try:
            ...
            embed.add_field(name=f'Version', value=config.version)
...
async def setup(bot):
    await bot.add_cog(Ping(bot), guilds=[discord.Object(id=config.server_id)])
